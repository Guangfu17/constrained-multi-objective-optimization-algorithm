...
%   Example:
%
%       main('-algorithm',@PPSNSGA2,'-problem',@DTLZ2,'-N',200,'-M',10)
%
%   runs PPSNSGA2 on 10-objective DTLZ2 with a population size of 200.
%
%       for i = 1 : 10
%           main('-algorithm',@PPSNSGA2,'-problem',@DTLZ1,'-run',i,'-save',5)
%       end
%
%   runs PPSNSGA2 on DTLZ1 for 10 times, and each time saves 5 populations to
%   a file in /Data/PPSNSGA2.
